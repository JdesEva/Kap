...
export default class PreferencesPage extends React.Component {
  ...
  componentDidMount() {
    ipc.answerMain(
      "open-plugin-config",
      preferencesContainer.openPluginsConfig
    );
    ipc.answerMain("options", preferencesContainer.setNavigation);
    ipc.answerMain("mount", async () =>
        ...
        {(t) => (
          <div className="cover-window">
            ...
            <Provider inject={[preferencesContainer]}>
              <WindowHeader title={t("Preferences")}>
            ...
            <style jsx global>{`
              ...
              :root {
                ...
                --navigation-item-box-shadow-active: var(
                  --navigation-item-box-shadow
                );
